...
$.currentWindow = function () {
    var iframeId = top.$(".Diana_iframe:visible").attr("id");
...
$.fn.formSerialize = function (formdate) {
    ...
    if (!!formdate) {
        for (var key in formdate) {
            ...
            var value = $.trim(formdate[key]).replace(/NULL;/g, '');
...
$.fn.authorizeButton = function () {
    var moduleId = top.$(".Diana_iframe:visible").attr("id").substr(6);
