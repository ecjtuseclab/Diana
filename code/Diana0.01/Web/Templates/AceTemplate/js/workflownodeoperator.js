...
function ViewModel() {
    ...
    me.DeleteUrl = "../index.ashx?ctrl=workflownodeoperator&action=DeleteForm";
...
function vmExtend() {
    ...
    me.LoadModels = function (pageIndex) {
        ...
        $ace.get("../index.ashx?ctrl=workflownodeoperator&action=showAll", params, function (result) {
...
function Dialog(vm) {
    ...
    me.OnSave = function () {
        ...
        //提交表单数据
        $ace.post("../index.ashx?ctrl=workflownodeoperator&action=SubmitForm", model, function (result) {
            $ace.msg(result.Msg);
            me.Close();
            vm.LoadModels();
        });
