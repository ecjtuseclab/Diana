var table = $('#workflowinstances_Table'),
    layfm = 'workflowinstances_layer_fm',
    searchfm = 'workflowinstances_search_fm',
    layContent = $('#workflowinstances_layer'),
    toolbar = "#workflowinstances_Toolbar",
...
$(table).bootstrapTable({
    ...
    columns: [{ checkbox: true },
           { field: 'id', title: 'id', switchable: 0, editable: 0 ,visible: 0},
            { field: 'wfid', title: '工作流', switchable: !0, editable: !0, visible: !0 },
            { field: 'ownertabledataid', title: '业务表', switchable: !0, editable: !0, visible: !0 },
            { field: 'currentnodeid', title: '当前节点', switchable: 0, editable: !0, visible: !0 },
            { field: 'status', title: '状态', switchable: !0, editable: !0, visible: !0 },
            { field: 'datalock', title: '锁定状态', switchable: !0, editable: !0, visible: !0 },
            { field: 'nodcode', title: '编号', switchable: !0, editable: !0, visible: !0 },
            ],
