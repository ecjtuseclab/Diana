var table = $('#workflowinstancetracings_Table'),
    layfm = 'workflowinstancetracings_layer_fm',
    searchfm = 'workflowinstancetracings_search_fm',
    layContent = $('#workflowinstancetracings_layer'),
    toolbar = "#workflowinstancetracings_Toolbar",
...
$(table).bootstrapTable({
    ...
    columns: [{ checkbox: true },
           { field: 'id', title: 'id', switchable: 0, editable: 0 ,visible: 0},
            { field: 'instanceid', title: '工作流影子表', switchable: !0, editable: !0, visible: !0 },
            { field: 'startnode', title: '开始节点', switchable: 0, editable: !0, visible: !0 },
            { field: 'endnode', title: '结束节点', switchable: 0, editable: !0, visible: !0 },
            { field: 'executeaction', title: '执行动作', switchable: !0, editable: !0, visible: !0 },
            { field: 'executer', title: '执行人', switchable: !0, editable: !0, visible: !0 },
            { field: 'executetime', title: '执行时间', switchable: !0, editable: !0, visible: !0 },
            { field: 'remark', title: '备注', switchable: !0, editable: !0, visible: !0 },
            ],
