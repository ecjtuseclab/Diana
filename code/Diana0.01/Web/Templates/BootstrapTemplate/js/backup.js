var table = $('#backup_Table'),
    layfm = 'backup_layer_fm',
    searchfm = 'backup_search_fm',
    layContent = $('#backup_layer'),
    toolbar = "#backup_Toolbar",
...
$(table).bootstrapTable({
    ...
    columns: [{ checkbox: true },
           { field: 'id', title: 'id', switchable: 0, editable: 0 ,visible: !0},
            { field: 'databasename', title: '数据库名', switchable: 0, visible: !0 },
            { field: 'backupname', title: '备份名', switchable: !0,  visible: !0 },
            { field: 'backupsize', title: '备份大小', switchable: !0,  visible: !0 },
            { field: 'backuptime', title: '时间', switchable: !0,  visible: !0 },
            { field: 'backuppersonnel', title: '备份人', switchable: !0, visible: !0 },
            { field: 'instructions', title: '说明', switchable: !0,  visible: !0 },
            { field: 'absolutepath', title: '绝对路径', switchable: !0,  visible: 0 },
            { field: 'relativepath', title: '相对路径', switchable: !0,  visible: 0 },
            ]
});