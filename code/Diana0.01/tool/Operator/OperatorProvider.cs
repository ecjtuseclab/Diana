namespace Diana.tool.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "diana_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("diana_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("diana_licence", Licence.GetLicence());
        }
