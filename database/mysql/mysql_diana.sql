...
Source Database       : diana

Target Server Type    : MYSQL
Target Server Version : 50547
File Encoding         : 65001

Date: 2018-01-28 17:58:36
*/
...
-- Records of action
-- ----------------------------
INSERT INTO `action` VALUES ('1', 'roleControler', 'sss', 'ss', '0', 'NULL', '11', 'ss');
INSERT INTO `action` VALUES ('3', '新增', '1', '3.33333E+14', '0', '1', '111', '1');
INSERT INTO `action` VALUES ('4', '删除', '11', '11', '3', '1', '1111', '11');
INSERT INTO `action` VALUES ('11', '修改', 'http://www.baidu,com', '修改你的页面', '0', '1', '4', '未知');
...
CREATE TABLE `resource` (
  ...
  `resourcescript` varchar(255) DEFAULT NULL,
  `resourceowner` varchar(255) DEFAULT NULL,
  `resourcelevel` int(255) DEFAULT NULL,
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '管理员', '1', '2018-01-16 20:27:15');
INSERT INTO `role` VALUES ('25', '普通用户', '3', '2018-01-16 20:27:17');
INSERT INTO `role` VALUES ('26', '会员', '3', '2018-01-08 20:27:20');
INSERT INTO `role` VALUES ('28', '黄金会员', '3', '2018-01-13 20:27:24');
INSERT INTO `role` VALUES ('32', '一般用户', '0', '2018-01-01 20:27:26');
INSERT INTO `role` VALUES ('33', '235', '2', '2017-12-11 20:27:31');
...
-- Records of workflow
-- ----------------------------
INSERT INTO `workflow` VALUES ('3', 'Workflowtest', 'Test', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'workflowInstance', '1', '1', 'State1');
INSERT INTO `workflow` VALUES ('4', 'wf1', 'Tes22', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'state2');
INSERT INTO `workflow` VALUES ('5', 'wf1', 'Tes22', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'Fieldname');
INSERT INTO `workflow` VALUES ('6', 'wf1', 'Tes22', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'State');
INSERT INTO `workflow` VALUES ('7', 'wf1', 'Tes22', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'State2');
INSERT INTO `workflow` VALUES ('8', 'wf1', 'Tes22', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'State4');
INSERT INTO `workflow` VALUES ('9', 'wf1', 'Tes223', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'State5');
INSERT INTO `workflow` VALUES ('10', 'wf1', 'Tes22', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'State6');
INSERT INTO `workflow` VALUES ('11', 'wf1', '4', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'State7');
INSERT INTO `workflow` VALUES ('12', 'wf1', 'Tes222', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'State8');
INSERT INTO `workflow` VALUES ('13', 'wf1', '45', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('14', 'wf1', '34', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('15', 'wf1', '3', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('16', 'wf1', '23', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('17', 'wf1', 'Tes221', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('18', 'wf1', 'Tes221', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('19', 'wf1', 'Tes221', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('20', 'wf1', 'Tes221', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('21', 'wf1', 'Tes221', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('22', 'wf1', 'Tes221', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('23', 'wf1', 'Tes221', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', 'TestTable', 'WorkflowInstance', '1', '1', 'NULL');
INSERT INTO `workflow` VALUES ('24', '2121', '12343', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0', '321321', '213', '2', '2', '3213');
INSERT INTO `workflow` VALUES ('25', '12312', '123', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '213', '124撒旦法dd', '的阿萨德阿瑟', '2', '2', '单位但我确定是a');
...
-- ----------------------------
INSERT INTO `workflownodeaction` VALUES ('2', '3', 'Insert', '新增', '1', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'NULL', '1', null, '1');
INSERT INTO `workflownodeaction` VALUES ('3', '3', 'Audit', '审核', '1', '3', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'NULL', '1', null, '1');
INSERT INTO `workflownodeaction` VALUES ('4', '7', '阿斯顿撒大s', ' 阿瑟上的 的撒', '0', '0', '2', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '啊实打实的', '2', null, '1');
...
-- ----------------------------
INSERT INTO `workflownodeoperator` VALUES ('1', '2', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', '1');
INSERT INTO `workflownodeoperator` VALUES ('3', '3', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', '1');
INSERT INTO `workflownodeoperator` VALUES ('4', '3', '2', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', '1');
INSERT INTO `workflownodeoperator` VALUES ('5', '3', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', '1');
INSERT INTO `workflownodeoperator` VALUES ('6', '2', '22', '2', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', '1');
INSERT INTO `workflownodeoperator` VALUES ('7', '2', '1', '2', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', '1');
